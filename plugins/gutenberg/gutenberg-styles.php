...
if ( ! function_exists( 'scientia_gutenberg_add_theme_vars' ) ) {
	add_filter( 'scientia_filter_add_theme_vars', 'scientia_gutenberg_add_theme_vars', 10, 2 );
	function scientia_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'scientia_gutenberg_get_css' ) ) {
	add_filter( 'scientia_filter_get_css', 'scientia_gutenberg_get_css', 10, 2 );
	function scientia_gutenberg_get_css( $css, $args ) {
