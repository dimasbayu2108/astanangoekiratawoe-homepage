...
if ( ! function_exists( 'scientia_booked_get_css' ) ) {
	add_filter( 'scientia_filter_get_css', 'scientia_booked_get_css', 10, 2 );
	function scientia_booked_get_css( $css, $args ) {
...
table.booked-calendar tbody tr td:not(.prev-month):not(.prev-date):hover {
