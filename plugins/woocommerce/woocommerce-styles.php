...
if ( ! function_exists( 'scientia_woocommerce_get_css' ) ) {
	add_filter( 'scientia_filter_get_css', 'scientia_woocommerce_get_css', 10, 2 );
	function scientia_woocommerce_get_css( $css, $args ) {
...
.widget.woocommerce.widget_shopping_cart .woocommerce-mini-cart.cart_list.product_list_widget .mini_cart_item a,
...
.woocommerce .shop_mode_thumbs ul.products li.product .post_item .post_featured, .woocommerce-page .shop_mode_thumbs ul.products li.product .post_item .post_featured {
	background-color: {$colors['alter_bg_color']};
}
.woocommerce .shop_mode_thumbs ul.products li.product .post_item .post_featured:hover, .woocommerce-page .shop_mode_thumbs ul.products li.product .post_item .post_featured:hover {
...
/* Shop mode selector */
.scientia_shop_mode_buttons a {
	color: {$colors['text_link']};
}
.scientia_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .scientia_shop_mode_buttons a.woocommerce_thumbs,
