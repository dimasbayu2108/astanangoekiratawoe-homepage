...
WordPress version: required at least 4.5, tested up to 5.2
...
Please install and activate it before starting to use the theme Scientia.
...
Theme documentation is available on http://scientia.themerex.net/doc
...
2) Icons (css/font-icons/*.*)
   The icon set used in Scientia is Fontello.
